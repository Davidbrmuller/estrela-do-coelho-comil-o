...
var estrela1,estrela2,estrelaimg
var balao7
...
botao=createImg("baloon2.png")
botao.position(260,370)
botao.size(120,120)
botao.mouseClicked(bloontd6)
  //botão 1
  ...
  estrela2= createSprite(200,370,20,20)
...
function draw() 
{
  ...
  if(collide(fruit,estrela1,20)===true){
